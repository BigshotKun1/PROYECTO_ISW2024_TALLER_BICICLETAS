...
import { creProd, delProd, getProd, getProductos, updProd, } from "../controllers/productos.controller.js";
...
router.get("/", getProductos); //* http://localhost:3000/api/productos - get 
